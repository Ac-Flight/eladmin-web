<template>
  <div class="app-container">
    ...
    <el-table :data="tableModel.tableData" style="width: 100%;">
      ...
      <el-table-column prop="configName" label="类型编号" />
      <el-table-column prop="configRules" label="航天器材类型" />
      <el-table-column prop="isActive" label="类型描述" />
