<template>
  <div class="app-container">
    ...
    <el-table :data="tableModel.tableData" style="width: 100%;">
      ...
      <el-table-column prop="configName" label="装设备编号" />
      <el-table-column prop="configRules" label="所属车间" />
      <el-table-column prop="isActive" label="备注" />
      <el-table-column prop="addTime" label="装设备时间" />
