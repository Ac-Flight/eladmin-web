<template>
  <div class="app-container">
    ...
    <el-table :data="tableModel.tableData" style="width: 100%;">
      ...
      <el-table-column prop="configName" label="领用编号" />
      <el-table-column prop="configRules" label="领用车间" />
      <el-table-column prop="isActive" label="领用用途" />
      <el-table-column prop="addTime" label="领用数量" />
