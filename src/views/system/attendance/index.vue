<template>
  <div class="app-container">
    ...
    <el-table :data="tableModel.tableData" style="width: 100%;">
      ...
      <el-table-column prop="configName" label="人员名称" />
      <el-table-column prop="configRules" label="日期" />
      <el-table-column prop="isActive" label="考勤类型" />
      <el-table-column prop="addTime" label="打卡时间" />
      <el-table-column>
    ...
    return {
      ...
      tableModel: {
        tableData: [
          {
            configName: '张三',
            configRules: '2021-09-27',
            isActive: '上午',
            addTime: '2021-09-27 8:16:00'
          },
          {
            configName: '李四',
            configRules: '2021-09-27',
