<template>
  <div class="app-container">
    ...
    <el-table :data="tableModel.tableData" style="width: 100%;">
      ...
      <el-table-column prop="configName" label="送修件编号" />
      <el-table-column prop="configRules" label="送修件名称" />
      <el-table-column prop="isActive" label="送修件数量" />
      <el-table-column prop="addTime" label="送修时间" />
      <el-table-column prop="addTime1" label="负责人" />
      <el-table-column>
