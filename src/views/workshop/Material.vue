<template>
  <div class="app-container">
    ...
    <el-table :data="tableModel.tableData" style="width: 100%;">
      ...
      <el-table-column prop="configRules" label="类型" />
      <el-table-column prop="isActive" label="入库时间" />
      <el-table-column prop="addTime" label="数量" />
      <el-table-column prop="addTime1" label="所属车间" />
      <el-table-column>
