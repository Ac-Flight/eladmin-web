  ...
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-dialog :visible.sync="dialogModel.visible" :title="dialogModel.title">
        ...
        <div slot="footer" class="dialog-footer">
          <el-button type="text" @click="dialogModel.visible = false">取消</el-button>
          <el-button type="primary" @click="dialogModel.visible = false">确认</el-button>
        </div>
      </el-dialog>
      <!--表格渲染-->
      <el-table
